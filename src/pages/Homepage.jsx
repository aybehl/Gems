    ...
    return (
        <>
            <main>
                ...
                <section className="flex flex-col gap-y-[3rem] bg-amber p-[3rem] pb-[4rem] items-center">
                    ...
                    <div className="flex gap-[4rem] justify-center">
                        ...
                        <div>
                            <img src="/homepage/binocular-image.svg" alt="binocular image" />
                        </div>
                ...
                <section className="flex flex-col bg-fresh-green p-[5rem] gap-[4rem]">
                    ...
                    <div className="flex gap-x-[3.375rem]">
                        <div className="flex flex-col items-center bg-bubble-gum-pink gap-y-[2.5rem] rounded-[1rem] p-[1.5rem] w-1/3 hover:ring-black hover:ring-4">
                            <img src="/homepage/gem-icon.svg" alt="A gem icon" className="h-auto"/>
                            <div className="font-chivo font-normal text-[1.5rem] text-center w-[60%]">
                                <strong>Spotlight amazing local businesses</strong> where you can purchase food items and mementos unique to specific cultures
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center bg-pastel-yellow gap-y-[2.5rem] rounded-[1rem] p-[1.5rem] w-1/3 hover:ring-black hover:ring-4">
                            ...
                            <div className="font-chivo font-normal text-[1.5rem] text-center w-[60%]">
                                <strong>Introduce you to communities</strong> of fellow immigrants who clearly understand the challenges you are experiencing 
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center bg-amber gap-y-[2.5rem] rounded-[1rem] p-[1.5rem] w-1/3 hover:ring-black hover:ring-4">
                            ...
                            <div className="font-chivo font-normal text-[1.5rem] text-center w-[60%]">
                                <strong>Help you feel less homesick and afraid of being lost,</strong> both literally and figuratively
                            </div>
                        </div>
